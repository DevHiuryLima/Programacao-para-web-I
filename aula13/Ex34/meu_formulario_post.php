				...
				<td>
					<form action="exibe_dados_post.php"  method="POST">
                        ...
                        <legend><strong>Dados Pessoais</strong></legend>
							...
							<br>
							Sexo:
								<label for="sex_masc"><input type="radio" name="sexo" value="masculino" id="sex_masc" checked/>Masculino</label>
								<label for="sex_fem"><input type="radio" name="sexo" value="feminino" id="sex_fem" />Feminino</label>
							<br>
						</fieldset>
						<br>
